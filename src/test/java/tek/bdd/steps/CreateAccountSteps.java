...
public class CreateAccountSteps extends SeleniumUtility {
    ...
    public void fillUpCreateAccountForm() {
        ...
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Ayesha");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "Rasa");
    ...
    public void whenTheUserFillUpSignUpForm() {
        sendText(CreateAccountPageObject.USERNAME_INPUT, "Ayesha");
        sendText(CreateAccountPageObject.PASSWORD_INPUT, "Ayesha123$");
        sendText(CreateAccountPageObject.CONFIRM_PASSWORD_INPUT, "Ayesha123");
    }
    ...
    public void fillUpCreateAccountFormPage() {
        ...
        sendText(CreateAccountPageObject.EMAIL_INPUT, "Ayesha422@gmail.com");
        selectFromDropDown(CreateAccountPageObject.PREFIX_SELECT, "Mrs.");
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Ayesha");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "Rasa");
        selectFromDropDown(CreateAccountPageObject.GENDER_SELECT, "Female");
